...
<p style="text-align: justify">Después de entender cómo interactuan y funcionan cada uno de los componentes y procesos que conforman la máquina, me pregunte si era posible obtener una reverse shell bash interactiva con privilegios sin necesidad de escalar desde un usuario con menos privilegios.</p>

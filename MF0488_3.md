...
<p style="text-align: justify">El único problema que nos encontramos es que, para acceder al apartado del "editor de workflows", necesitamos autenticarnos. Por suerte disponemos de unas credenciales que son válidas para <b>SSH</b>, pero como la gente tiene la <b>manía</b> fea de reutilizar contraseñas, procedemos a <b>probar</b> si nos permite el ingreso al editor.</p>
...
Ahora ya podemos movernos a los directorios de todos los usuarios. Vamos a por la siguiente flag:
